...
funclib.js 是一个简单、易用、贴进业务逻辑的JavaScript函数库，以高效完成业务代码为目标，具有“通用、实用、易用、好用”等特点！类似于 underscore 和 lodash。 跟它们对比，funclib.js省去了很多js自带的或者不常用的方法，并且改进和拓展了很多方法的使用方式。<br>
