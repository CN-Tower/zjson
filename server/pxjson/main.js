    ...
    Formatter.prototype.arrayHandler = function (ps, onEnd) {
        if (ps.obj.length > 0) {
            ...
            for (var i = 0; i < ps.obj.length; i++) {
                var curIndent_1 = this.isExpand ? this.help.getCurIndent(this.baseIndent, this.level) : '';
            ...
            this.level--;
            var curIndent = this.isExpand ? this.help.getCurIndent(this.baseIndent, this.level) : '';
        ...
        if (fn.objLen(ps.obj) > 0) {
            ...
            for (var key in ps.obj) {
                if (ps.obj.hasOwnProperty(key)) {
                    ...
                    var curIndent_2 = this.isExpand ? this.help.getCurIndent(this.baseIndent, this.level) : '';
