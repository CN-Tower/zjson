...
/* harmony import */ var rxjs_operator_window__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rxjs/operator/window */ "./node_modules/rxjs-compat/_esm5/operator/window.js");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(appService) {
        ...
        this.getTimeStr = function () { return moment__WEBPACK_IMPORTED_MODULE_6__().format('MM-DD HH:mm:ss'); };
    ...
    AppComponent.prototype.maximalPanel = function (type) {
        ...
        var $body = $('html, body');
        var bodyH = $body.height() - 94;
        var bodyW = $body.width();
        var pW = bodyW - 40;
        var pH = bodyH > 500 ? bodyH : 500;
        switch (type) {
            case 'src':
    ...
    AppComponent.prototype.ngAfterViewInit = function () {
        ...
        $('#z-resize').mousedown(function (e) {
            ox = e.clientX;
            $(rxjs_operator_window__WEBPACK_IMPORTED_MODULE_5__["window"]).on('mousemove', resizeCodeZone)
                .mouseup(function () {
                $(this).off('mousemove', resizeCodeZone);
            });
        });
        function resizeCodeZone(e) {
            $('.src-text').blur();
            var ww = $('#worker').width();
            nx = e.clientX;
            if (nx !== ox) {
